...
class GetFacultyStatisticUseCase(GenericUseCase):

    def __init__(self, repository: PpsRepositoryAbstract, faculty:str, statistic_type:list) -> None:
    ...
    def execute(self) -> StatisticResponse:
        try:
            return self._repository.get_faculty_statistic(self._faculty, self._statistic_type)
