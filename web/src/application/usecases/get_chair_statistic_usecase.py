...
class GetChairStatisticUseCase(GenericUseCase):

    def __init__(self, repository: PpsRepositoryAbstract, faculty:str, chair:str, statistic_type:list) -> None:
    ...
    def execute(self) -> StatisticResponse:
        try:
            return self._repository.get_chair_statistic(self._faculty, self._chair, self._statistic_type)
